    ...
    if ($query->have_posts()) {
        ...
        while ($query->have_posts()) {
            ...
            if ($result_count <= $maxResults) {
                $query->the_post();
                echo \Roots\view('components.card.result');
            } else {
                break;
            }
        }
        ...
        if ($count > $maxResults) {
            echo '<button type="submit" form="search-form" class="more-results">'. __('Bekijk alle artikelen', 'sage') .'</button';
        }

        wp_reset_postdata();
    } else {
        echo '<div class="no-results">'. __('Geen resulaten gevonden', 'sage') .'</div>';
    }
